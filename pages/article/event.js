...
const stripPTags = (html) => {
  ...
  const pageTitle = `House Kari | ${t('menu.event')}`;
  ...
  return (
    <>
      ...
      <div className={banner.breadcrumbs}>
        <p>{t('menu.home')} / {t('menu.article')} / <span>{t('menu.event')}</span></p>
      </div>
        ...
        <div className={styles.section1_layout}>
          <div className={styles.section1_tab_layout}>
            <div className={styles.section1_tab}>
              ...
              <Link href='/article/event'><button className={styles.activeTab}>{t('menu.event')}</button></Link>
